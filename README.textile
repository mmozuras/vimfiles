...
* "vim-yankring":http://www.vim.org/scripts/script.php?script_id=1234 - maintains a history of yanks and deletes. History can be shared between multiple instances of vim.
